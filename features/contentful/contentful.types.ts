...
export type ResumeCollectionQueryVariables = Exact<{
  isPreview?: InputMaybe<Scalars['Boolean']['input']>;
}>;

export type ResumeCollectionQuery = {
  __typename?: 'Query';
  resumeCollection?: {
    __typename?: 'ResumeCollection';
    items: Array<{
...
export function getSdk(
  ...
  return {
    resumeCollection(
      variables?: ResumeCollectionQueryVariables,
      requestHeaders?: GraphQLClientRequestHeaders
    ): Promise<ResumeCollectionQuery> {
      return withWrapper(
        wrappedRequestHeaders =>
          client.request<ResumeCollectionQuery>(
